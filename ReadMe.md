...
_Note: This is a lesson that takes a long time to load because it has to download the dependencies and then start the React development server._
...
**In this activity, our task is to create a login form with validation using Formik.**

our form should include the following:

- An Email field
- A Password field
- A Submit Button

our form should implement the following input validation rules:
